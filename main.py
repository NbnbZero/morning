...
def get_bless():
  test = "drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum drum"
  bless = ["醒醒！醒醒！古德猫宁！", "今天也给我好好吃饭！", "今天也会有惊喜嘛！", "所以今天也要开开心心！", "zxr昨天做梦了吗！", "叮！又是幸运的一天！", "今天也要健健康康喔！"]
  return test#random.choice(bless)
