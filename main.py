...
test = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
...
def get_weather():
  ...
  weather = "Rain, Partially cloudy throughout the day"#res['days'][0]['conditions']
...
def get_words():
  words_db = ["This time you can face the rain; Next time you can beat the pain.", "입에 붙어, like a snack, 다시, repeat, 되는 trap 이 리듬, make it pop like soda", "Watch me~ Ooh, 24/7 아직 부족해~ 들리니? 함께 있는 매일, put it on replay", "뱉는 순간 heartbeat, bum, bum, bum! Cool kid 다운 kick on the drum, drum, drum!", "令人愉悦的声音 笑意盈盈；一同唱起的歌声 一起去往那时 愉快的曾经。",
           ...
           "'She no longer needs me' 널 원할 수록 내 현실은 무거워지고 있어", "그럼에도 나는 더 참지 못해 지금 너에게 달려 가고 싶어 나의 모든 순간이 너를 원하고 있으니", "I'm not going back, back, back, back, back! 다짐했던 난데 우는 널 보면 미쳐 너는 내게 왜, 왜, 왜, 왜, 왜, 왜", "너 이럴 때 마다 또 무너져 난 이제는 다시는 더 이상 더 이상 날 찾지마, no~ no!"]
...
if days_to_next_birth==0:
  ...
  bless = bless_list[4]#bless_list[tmp]
